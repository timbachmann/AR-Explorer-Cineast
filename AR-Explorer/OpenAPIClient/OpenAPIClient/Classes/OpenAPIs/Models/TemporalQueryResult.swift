...
public struct TemporalQueryResult: Codable, JSONEncodable, Hashable {
    ...
    public var content: [TemporalObject]?
    public var messageType: MessageType?

    public init(queryId: String? = nil, content: [TemporalObject]? = nil, messageType: MessageType? = nil) {

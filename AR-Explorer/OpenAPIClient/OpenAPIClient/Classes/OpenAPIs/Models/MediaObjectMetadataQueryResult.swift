//
// MediaObjectMetadataQueryResult.swift
//
...
public struct MediaObjectMetadataQueryResult: Codable, JSONEncodable, Hashable {
    ...
    public var content: [MediaObjectMetadataDescriptor]?
    public var messageType: MessageType?

    public init(queryId: String? = nil, content: [MediaObjectMetadataDescriptor]? = nil, messageType: MessageType? = nil) {

...
public struct MediaObjectQueryResult: Codable, JSONEncodable, Hashable {
    ...
    public var content: [MediaObjectDescriptor]?
    public var messageType: MessageType?

    public init(queryId: String? = nil, content: [MediaObjectDescriptor]? = nil, messageType: MessageType? = nil) {

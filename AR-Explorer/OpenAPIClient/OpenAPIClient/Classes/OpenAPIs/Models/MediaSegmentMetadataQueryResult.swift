//
// MediaSegmentMetadataQueryResult.swift
//
...
public struct MediaSegmentMetadataQueryResult: Codable, JSONEncodable, Hashable {
    ...
    public var content: [MediaSegmentMetadataDescriptor]?
    public var messageType: MessageType?

    public init(queryId: String? = nil, content: [MediaSegmentMetadataDescriptor]? = nil, messageType: MessageType? = nil) {

 ...
 */
public class CameraServiceCapture {
    ...
    @Published public var photo: PhotoCapture?
            ...
            sessionQueue.async {
                ...
                let photoCaptureProcessor = PhotoCaptureProcessor(with: photoSettings, willCapturePhotoAnimation: { [weak self] in
                    ...
                    if let data = photoCaptureProcessor.photoData {
                        self?.photo = PhotoCapture(originalData: data, heading: heading, yaw: currYaw, pitch: currPitch)
                        print("passing photo")
                    } else {
                        print("No photo data")
                    }
 ...
 */
extension CameraServiceCapture {
    enum LivePhotoMode {
        case on
        case off
    }
